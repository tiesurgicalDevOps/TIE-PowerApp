...
$SiteURL="https://tiesurgical.sharepoint.com/sites/QA/"
$LibraryName="Documents"
$SourceFolderPath="Z:\JobSystem\PowerApp Data\"
...
Upload-SPOFile -SourceFilePath $SourceFolderPath -TargetFileURL $SiteURL